...
int main(void)
{
    ...
    graph_add_rule(g, 0, "echo at 0");
    graph_add_rule(g, 1, "echo at 1");
    graph_add_rule(g, 2, "echo at 2");
    graph_add_rule(g, 3, "echo at 3");
    graph_add_rule(g, 4, "echo at 4");
    graph_add_rule(g, 5, "echo at 5");
    graph_add_rule(g, 6, "echo at 6");
